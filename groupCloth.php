    	...
    	<div class="row">
        	<div class="span12">
                ...
                <div class="span12">
                	...
                	<input type="text" placeholder="Want to give us more info?" style="width:40%"/>
                </div>
                <div class="span12">
                	<h3>Clothing Texture Upload: (ignore if being made)</h3>
